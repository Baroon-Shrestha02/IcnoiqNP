const projectsData = [
  {
    ...
    year: "2025",
    height: 400,
    category: ["Websites", "Graphics & Motion"],
    longDescription:
  ...
  },
  {
    ...
    year: "2025",
    height: 380,
    category: ["Graphics & Motion", "UI/UX Design"],
    longDescription:
  ...
  {
    image: "Uploads/works/semla/favicon.png",
    title: "Semla Educational Consultancy",
    subtitle: "Study in Japan Consultancy",
    link: "https://semlaconsultancy.vercel.app",
    description:
      "Semla Educational Consultancy focuses on guiding students who want to pursue higher education in Japan. We developed a responsive website that highlights their services, Japanese language programs, and cultural learning opportunities, helping them connect with aspiring students more effectively.",
    tags: ["Web Design", "Responsive Website", "Education & Consultancy"],
    year: "2025",
    height: 380,
    category: "Websites",
    longDescription:
      "Semla Educational Consultancy is dedicated to supporting students in achieving their dreams of studying in Japan, with a strong emphasis on learning the Japanese language and culture. Their team provides personalized guidance for admissions, language preparation, and cultural orientation. Before working with us, they lacked a modern digital presence to communicate their services and engage with a wider student audience online. Our goal was to build a professional, mobile-friendly website that would act as both an informational hub and a first point of contact for prospective students.",
    longDescription1:
      "We designed and developed a responsive website that clearly outlines Semla’s study abroad programs, admission support, and Japanese language training services. The platform was built with user-friendly navigation to help students quickly find details about studying in Japan, while also including inquiry and contact forms to simplify communication. With a clean and professional look, the site builds trust while being accessible on all devices—ensuring students and parents can easily access information anytime, anywhere.",
    longDescription2:
      "The new website has allowed Semla Educational Consultancy to establish a stronger digital identity and expand their reach among students seeking opportunities in Japan. By making program information clear and easily accessible online, the consultancy has seen increased inquiries and engagement. The responsive design also ensures that students browsing from mobile devices—often the primary medium for younger audiences—have a seamless experience. Overall, the website became a valuable tool for Semla to promote their expertise in Japanese study programs, attract more students, and build credibility in the competitive consultancy space.",
    challenge:
      "They lacked an online presence to effectively communicate their Japan-focused study programs and services.",
    solution:
      "We created a responsive, user-friendly website that showcases their Japan study opportunities, Japanese language learning, and cultural programs while making it easy for students to reach out.",
    result:
      "Semla Educational Consultancy now engages with more students online, receiving higher inquiries and building trust through a modern digital presence.",
    mediaAssets: [],
  },
  {
  ...
  {
    image: "Uploads/works/bakery/cake.jpg",
    title: "Bakery",
    subtitle: "UI Layout Design",
    link: "https://bakery-seven-theta.vercel.app",
    description:
      "Bakery wanted a fresh, modern design concept for their online presence. Based on their requirements, we designed a clean and inviting frontend UI layout that reflects the warmth of their bakery while focusing on user-friendly navigation and presentation of products.",
    tags: ["UI Design", "Frontend Layout", "Food & Beverage"],
    year: "2025",
    height: 380,
    category: "UI/UX Design",
    longDescription:
      "Bakery, known for its handmade breads and pastries, approached us with the goal of creating a simple yet attractive digital identity. Instead of building a full website or backend system, the client requested a well-structured UI layout that could later be integrated into a complete platform. The focus was on crafting a visually appealing design that showcased their baked goods while providing an intuitive flow for customers browsing online.",
    longDescription1:
      "We designed a modern frontend layout with sections for featured products, categories, customer favorites, and seasonal specials. The design includes a clean hero section with a welcoming bakery theme, a product grid with imagery placeholders, and a simple cart icon for future e-commerce use. Bright accent colors and warm tones were used to mirror the bakery’s cozy atmosphere, while typography choices emphasized readability and friendliness.",
    longDescription2:
      "The final layout provided Bakery with a strong foundation for their online presence. While it was not a fully functional website, the UI design gave the client a clear vision of how their digital storefront could look and feel. This design-first approach allowed them to plan the next steps for development with confidence, ensuring their brand identity would be carried forward consistently when the full site is implemented.",
    challenge:
      "The bakery needed a professional UI concept that could serve as a digital foundation without requiring full backend development.",
    solution:
      "We created a clean, responsive frontend layout that showcases their bakery products and brand identity while leaving room for future functionality.",
    result:
      "Bakery now has a polished UI design that represents their brand online and serves as a blueprint for future development.",
  },
];
